...
impl Plugin for EnemyPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(Startup, startup_enemy.in_set(StartupGameSet::Initialize));
        app.add_systems(Update, spawn_enemies.in_set(UpdateGameSet::PreUpdate));
        app.add_systems(Update, enemy_shot.after(TransformSystems::Propagate));
        app.add_systems(
            PostUpdate,
