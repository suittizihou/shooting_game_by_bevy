...
pub fn mark_debri(mut debri_messages: MessageReader<DebriMessage>, mut debris: Query<&mut Debri>) {
...
pub fn garbage_collection(mut commands: Commands, debris: Query<(Entity, &Debri)>) {
